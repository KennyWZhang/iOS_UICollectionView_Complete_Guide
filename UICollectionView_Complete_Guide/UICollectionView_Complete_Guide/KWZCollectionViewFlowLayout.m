...
NSString * const KWZCollectionViewFlowLayoutBackgroundDecoration = @"DecorationIdentifier";
...
-(id)init
{
    ...
    [self registerClass:[KWZDecorationView class] forDecorationViewOfKind:KWZCollectionViewFlowLayoutBackgroundDecoration];
...
-(NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    for (UICollectionViewLayoutAttributes *attributes in attributesArray)
    {
        ...
        {
            UICollectionViewLayoutAttributes *newAttributes = [self layoutAttributesForDecorationViewOfKind:KWZCollectionViewFlowLayoutBackgroundDecoration atIndexPath:attributes.indexPath];
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForDecorationViewOfKind:(NSString *)decorationViewKind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([decorationViewKind isEqualToString:KWZCollectionViewFlowLayoutBackgroundDecoration])
    {
...
-(UICollectionViewLayoutAttributes *)initialLayoutAttributesForAppearingDecorationElementOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)decorationIndexPath
{
    ...
    if ([elementKind isEqualToString:KWZCollectionViewFlowLayoutBackgroundDecoration])
    {
