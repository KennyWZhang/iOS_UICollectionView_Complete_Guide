...
@implementation KWZCoverFlowFlowLayout
...
-(void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)attributes forVisibleRect:(CGRect)visibleRect
{
    ...
    [(KWZCollectionViewLayoutAttributes *)attributes setShouldRasterize:YES];
    [(KWZCollectionViewLayoutAttributes *)attributes setMaskingValue:maskAlpha];
}
